export class URLParams {
  ...
  public static parse(search: string) {
    ...
    try{
      return  Array.from(_search.entries())
        .reduce((map: Record<string, any>, [key, value]) =>{
          return {
            ...map,
...
export const toUrlString = (json: object | Array<any>) => encodeURIComponent(JSON.stringify(json))
...
export const toSearch = (json: object) => Object.entries(json)
